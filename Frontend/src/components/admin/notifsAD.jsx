...
const NotifsAD = () => {
  ...
  const [filters, setFilters] = useState({
    anomaly: 'all', // 'all', 'Approved absence', 'Inapproved absence'
  ...
  <div className="filter-group">
    ...
    >
      ...
      <option value="Inapproved absence">Unapproved Absences</option>
      ...
      <option value="12">December</option>
        ...
        {loading ? (
          ...
          <div className="alerts-table-container">
            {alerts.length === 0 ? (
              <div className="no-alerts">No alerts found matching your criteria</div>
            ) : (
